...
\maketitle
\begin{abstract}
  Recent advances in deep learning have produced state of art results in
  the task of automated essay scoring. The performance of these
  systems are not tested are approaching human level in the evaluation metrics,
  but their performance in actual scenarios is not explored. In this paper we explore
  how well these systems perform in real life scenarios as compared to non-neural
  models. We also explore some ways to overcome these shortcomings.
\end{abstract}
...
is from Taghipour et al. \cite{nea} 
