...
There is a recent surge in use of deep learning for the task of automated essay scoring.
These models have shown to out perform the traditional models based on hand coded features
and currently have the state of art performance in this task. The current state of art model
is from Taghipour et al. \cite{nea} and the state of art non-neural model is EASE \cite{ease}.
